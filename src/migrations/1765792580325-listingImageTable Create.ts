...
export class Migration1765792580325 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "listing_image" ("id" SERIAL NOT NULL, "url" character varying NOT NULL, "listingId" integer, CONSTRAINT "PK_5884ca1c2018515c1d738fd18e7" PRIMARY KEY ("id"))`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "listing" DROP COLUMN "image"`);
    await queryRunner.query(
      `ALTER TABLE "listing" ADD "image" character varying NOT NULL`,
    );
